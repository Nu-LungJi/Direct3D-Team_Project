...
CResMapEditorTerrainVIBuffer::CResMapEditorTerrainVIBuffer(const _string& sPath, ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
	: CResVIBuffer{ sPath, pDevice, pContext }
{
}

CResMapEditorTerrainVIBuffer::~CResMapEditorTerrainVIBuffer()
{
}

HRESULT CResMapEditorTerrainVIBuffer::Load(const std::any& arg)
{
...
HRESULT CResMapEditorTerrainVIBuffer::Unload(const std::any& arg)
{
	return S_OK;
}

SPtr<CResMapEditorTerrainVIBuffer> CResMapEditorTerrainVIBuffer::Create(const _string& sPath)
{
	return ToSPtr(new CResMapEditorTerrainVIBuffer{ sPath, CGameInstance::Get().GetGraphicDevice() , CGameInstance::Get().GetGraphicDeviceContext() });
}
