...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, NONBLEND_INSTANCED, NONBLEND, NONBLEND_MAPMESH, BLEND, BLEND_MAPMESH, DECAL, LIGHT, REFLECTION, EFFECT, SKYBOX, COLLIDER, UI3D, UI, END };
...
#undef X	
	...
	enum class UI_TYPE{ CONTAINER, TEXUI, FLIPBOOK, TEXT, BUTTON, SPELLMETER, HPBAR, HPFILL, LEFTHPFILL, MINIMAP, SPELLBTN, SHORTCUT_ICON, DISOLVE, GAMEOVERMASK, VIDEOOBJ, CURSOR, GENERAL_BUTTON, NINE_SLICE, END };
	...
	enum class B_SLOTNUMBER { PER_OBJECT, PER_PASS, BONES, MATERIAL, LIGHT, ENVLIGHT = 6, UI = 7, GPUPART = 9};
