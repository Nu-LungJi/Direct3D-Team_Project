...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, NONBLEND, NONBLEND_INSTANCED, BLEND, LIGHT, EFFECT, SKYBOX, COLLIDER, UI, END };
...
#undef X	
	...
	enum class UI_TYPE{ CONTAINER, TEXUI, FLIPBOOK, TEXT, BUTTON, SPELLMETER, HPBAR, HPFILL, LEFTHPFILL, END };
