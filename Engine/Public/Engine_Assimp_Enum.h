...
#define ENG_AI_TEXTURE_TYPE_MAX aiTextureType_GLTF_METALLIC_ROUGHNESS
    enum CHUNCK_TYPE { CHUNK_MESH, CHUNK_MATERIAL, CHUNK_TEXTURE, CHUNK_BONE, CHUNK_ANIM };
}
