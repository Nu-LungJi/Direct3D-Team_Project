...
#ifdef GAME_QUALITY_LEVEL3
#define MAX_NORMAL_LIGHT_RENDER_COUNT	16
#define MAX_SHADOW_LIGHT_RENDER_COUNT	4

#define	MAX_POINT_SHADOW_ACTIVE_COUNT	1
#define	MAX_SPOT_SHADOW_ACTIVE_COUNT	2
#endif
