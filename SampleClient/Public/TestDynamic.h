...
class CTestDynamic final : public CGameObject
{
public:
	DECLARE_DERIVED_TYPE(CTestDynamic, CGameObject)
...
private:
	CTestDynamic();
	CTestDynamic(const CTestDynamic& prototype);
	~CTestDynamic() override = default;
...
public:
	static E::UPtr<CTestDynamic> Create();
