...
class CTestThirdPersonCamera final : public CCameraObject
{
public:
...
public:
	DECLARE_DERIVED_TYPE(CTestThirdPersonCamera, CCameraObject)

private:
	CTestThirdPersonCamera();
	CTestThirdPersonCamera(const CTestThirdPersonCamera& rhs);
	~CTestThirdPersonCamera() override;
...
public:
	static UPtr<CTestThirdPersonCamera> Create();
