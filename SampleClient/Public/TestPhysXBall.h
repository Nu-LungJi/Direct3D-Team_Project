...
class CTestPhysXBall final : public CGameObject
{
public:
	DECLARE_DERIVED_TYPE(CTestPhysXBall, CGameObject)
...
public:
	static E::UPtr<CTestPhysXBall> Create();
