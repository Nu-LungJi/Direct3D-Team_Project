...
HRESULT CLightObject::RenderDefault(ID3D11DeviceContext* pContext, const E::RENDER_CTX& ctx)
{
	{
...
HRESULT CLightObject::RenderShadow(ID3D11DeviceContext* pContext, const E::RENDER_CTX& ctx)
{
	{
		E::CB_PER_OBJECT cbPerObject{};
		cbPerObject.matWorld = *GetTransform().GetCombinedWorldMatrix();
