...
CTestThirdPersonCamera::CTestThirdPersonCamera() = default;

CTestThirdPersonCamera::CTestThirdPersonCamera(const CTestThirdPersonCamera& rhs)
	: CCameraObject{ rhs }
{
}
...
HRESULT CTestThirdPersonCamera::Initialize(void* pArg)
{
...
void CTestThirdPersonCamera::PriorityUpdate(_float fTimeDelta)
{
...
void CTestThirdPersonCamera::UpdateFollow()
{
	if (CGameInstance::Get().GetActiveCamera() != this)
		return;
...
UPtr<CTestThirdPersonCamera> CTestThirdPersonCamera::Create()
{
	auto pInstance = ToUPtr(new CTestThirdPersonCamera{});
	if (FAILED(pInstance->InitializePrototype()))
		return nullptr;
	return pInstance;
}

UPtr<CPrototype> CTestThirdPersonCamera::Clone(void* pArg)
{
	auto pInstance = ToUPtr(new CTestThirdPersonCamera{ *this });
