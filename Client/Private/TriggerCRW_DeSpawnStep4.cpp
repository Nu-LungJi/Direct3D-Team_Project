...
void CTriggerCRW_DeSpawnStep4::OnTriggerEnter(
...
void CTriggerCRW_DeSpawnStep4::OnTriggerExit(
	E::CGameObject* pObj, const E::PX_ON_TRIGGER_DATA& info)
{
...
E::UPtr<CTriggerCRW_DeSpawnStep4> CTriggerCRW_DeSpawnStep4::Create()
{
	auto instance = E::ToUPtr(new CTriggerCRW_DeSpawnStep4{});
	if (FAILED(instance->InitializePrototype()))
		return nullptr;
	return instance;
}

E::UPtr<E::CPrototype> CTriggerCRW_DeSpawnStep4::Clone(void* pArg)
{
	auto instance = E::ToUPtr(new CTriggerCRW_DeSpawnStep4{ *this });
