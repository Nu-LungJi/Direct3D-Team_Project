...
private:
	...
	void BeginBlur(_float fIntensity, _float fUnscaledDuration);
	void EndBlur();
	...
	static constexpr _float PROTEGO_LIGHT_BLUR_INTENSITY = 2.f;
	static constexpr _float PROTEGO_HEAVY_BLUR_INTENSITY = 3.f;
	static constexpr _float PROTEGO_LIGHT_BLUR_DURATION = 0.1f;
	static constexpr _float PROTEGO_HEAVY_BLUR_DURATION = 0.16f;
	static constexpr _float COUNTER_BLUR_INTENSITY = 3.f;
	static constexpr _float COUNTER_BLUR_DURATION = 0.1f;
	static constexpr _float PROJECTILE_RELEASE_BLUR_INTENSITY = 4.5f;
	static constexpr _float PROJECTILE_RELEASE_BLUR_DURATION = 0.08f;
	...
	_bool m_bBlurActive{};
	_float m_fPreviousBlurIntensity{};
	_float m_fBlurRemainUnscaled{};
