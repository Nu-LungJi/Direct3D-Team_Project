...
class CMonEffect final : public CGameObject
{
public:
	DECLARE_DERIVED_TYPE(CMonEffect, CGameObject)
...
public:
	struct DESC : public CGameObject::GAMEOBJECT_DESC
	{
		...
		_float fRestitution{ -1.f };
		_float fPlayerCollisionDelay{ -1.f };
		PX_FILTER_DESC tFilter{
			.iLayer = ETOUI(COLLISION_LAYER::ENEMY_PROJECTILE),
...
public:
	static E::UPtr<CMonEffect> Create();
