...
class CDebugPlayerThirdPersonCamera final : public CCameraObject
{
public:
...
public:
	DECLARE_DERIVED_TYPE(CDebugPlayerThirdPersonCamera, CCameraObject)

private:
	CDebugPlayerThirdPersonCamera();
	CDebugPlayerThirdPersonCamera(const CDebugPlayerThirdPersonCamera& rhs);
	~CDebugPlayerThirdPersonCamera() override;
...
public:
	static UPtr<CDebugPlayerThirdPersonCamera> Create();
