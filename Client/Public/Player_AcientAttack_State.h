...
private:
	...
	static constexpr _float ACIENT_THROW_PULL_END_ANIM_RATIO = 0.1f;
	static constexpr _float ACIENT_THROW_STATE_RELEASE_RATIO = 0.85f;
	static constexpr _float ACIENT_THROW_SLOW_HOLD_DURATION = 0.5f;
	static constexpr _float ACIENT_THROW_WAIT_ANIM_SPEED = 0.1f;
	static constexpr _float ACIENT_THROW_TURN_SPEED = 540.f;
	static constexpr _float ACIENT_THROW_HOLD_SIDE_OFFSET = 3.f;
	static constexpr _float ACIENT_THROW_HOLD_HEIGHT = 4.2f;
	...
	static constexpr _float ACIENT_THROW_HOLD_SPIN_TURNS_PER_SECOND = 0.5f;
	static constexpr _float ACIENT_THROW_DIRECT_SPEED = 220.f;
	static constexpr _float ACIENT_THROW_SPIN_SPEED = 14.f;
	static constexpr _float ACIENT_THROW_SLOW_SCALE = 0.55f;
	static constexpr _float ACIENT_THROW_SLOW_POST_LAUNCH_DURATION = 0.03f;
	static constexpr _float ACIENT_THROW_SLOW_BLEND_IN = 0.015f;
	static constexpr _float ACIENT_THROW_SLOW_BLEND_OUT = 0.04f;
